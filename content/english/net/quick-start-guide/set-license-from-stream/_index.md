...
It supports a wide range of formats, including DOCX, XLSX, PDF, and many others. Refer to the [documentation](https://reference.groupdocs.com/editor/net/) for a complete list.
