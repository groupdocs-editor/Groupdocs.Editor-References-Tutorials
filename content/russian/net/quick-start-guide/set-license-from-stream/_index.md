...
### Какие форматы файлов поддерживает Groupdocs.Editor для .NET?
 Он поддерживает широкий спектр форматов, включая DOCX, XLSX, PDF и многие другие. Обратитесь к[документация](https://reference.groupdocs.com/editor/net/) для полного списка.