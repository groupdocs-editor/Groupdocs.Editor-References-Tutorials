...
A: รองรับ .NET Framework และ .NET Core หลายเวอร์ชันเสมอ ตรวจสอบ [หน้าแสดงความเข้ากันได้อย่างเป็นทางการ](https://docs.groupdocs.com/editor/net/) เพื่อดูรายละเอียด
